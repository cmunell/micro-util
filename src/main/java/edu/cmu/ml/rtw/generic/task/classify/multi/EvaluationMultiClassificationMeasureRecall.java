...
public class EvaluationMultiClassificationMeasureRecall extends EvaluationMultiClassificationMeasure {
	public enum Mode {
		MACRO,
		MACRO_WEIGHTED,
		MICRO
	...
	public EvaluationMultiClassificationMeasureRecall(Context context) {
		super(context);
	}
	...
	protected EvaluationMultiClassificationMeasure makeInstance() {
		return new EvaluationMultiClassificationMeasureRecall(this.context);
	}
